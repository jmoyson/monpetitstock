  ...
  return (
    <div className="flex flex-col min-h-screen bg-white dark:bg-zinc-950">
      ...
      <main className="flex-grow">
          ...
          <div className="container max-w-7xl mx-auto relative z-10 px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
              ...
              <p className="text-xl md:text-2xl text-zinc-600 dark:text-zinc-400 max-w-3xl mb-4">
                La solution la plus simple pour suivre votre inventaire. Pas de
                complexité, pas de formations, juste l'essentiel.
              </p>

              <p className="text-base text-zinc-500 dark:text-zinc-500 mb-10">
                Conçu pour les indépendants, artisans et associations qui
              ...
              <div className="flex flex-wrap justify-center gap-4 mb-8">
                <Button
                  asChild
                  size="lg"
                  className="bg-purple-600 hover:bg-purple-700 text-white shadow-lg shadow-purple-500/30 text-lg px-10 h-14"
                  id="cta-hero-start"
                >
                  <Link href="/login">
                ...
                <Button
                  ...
                  size="lg"
                  variant="outline"
                  className="text-lg px-10 h-14 border-2 border-purple-200 dark:border-purple-800 hover:bg-purple-50 dark:hover:bg-purple-950/50"
                  id="cta-hero-demo"
                >
        ...
        <section
          id="showcase"
          className="py-20 sm:py-28 bg-zinc-50 dark:bg-zinc-900/50 scroll-mt-20"
        >
          <div className="container max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-zinc-600 dark:text-zinc-400 max-w-3xl mx-auto">
                Une interface épurée qui vous donne toutes les informations
                essentielles sans vous noyer dans les détails
              </p>
            </div>
        ...
        <section id="features" className="py-20 sm:py-28 scroll-mt-20">
          <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mx-auto mb-16">
              ...
              <p className="text-xl text-zinc-600 dark:text-zinc-400 max-w-3xl mx-auto">
                Puissant mais simple. Concentrez-vous sur votre activité, pas
                sur l'outil.
              </p>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto">
              {[
                ...
                >
                  <div
                    className={`inline-flex items-center justify-center w-14 h-14 rounded-xl bg-gradient-to-br ${f.gradient} text-white mb-5 shadow-md`}
                  >
                    {f.icon}
                  </div>
          ...
          <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-xl text-zinc-600 dark:text-zinc-400">
                Commencez gratuitement. Passez au Pro uniquement quand vous en
                avez besoin.
              </p>
            </div>
            ...
            <div className="grid gap-8 lg:grid-cols-2 max-w-5xl mx-auto">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-zinc-600 dark:text-zinc-400">
                        Suffisant pour tester ou petits besoins
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-zinc-600 dark:text-zinc-400">
                        Gestion de stock, alertes, recherche
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
              ...
              <div className="relative bg-purple-600 dark:bg-purple-700 rounded-3xl p-8 flex flex-col text-white shadow-2xl shadow-purple-500/40 border-2 border-purple-500 dark:border-purple-600">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-purple-100">
                        Gérez autant de produits que vous voulez
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                ...
                <Button
                  asChild
                  className="w-full h-12 text-base bg-white text-purple-600 hover:bg-purple-50"
                  size="lg"
                  id="cta-pricing-pro"
                >
                  <Link href="/login">
            ...
            <div className="mt-12 text-center">
              <p className="text-zinc-600 dark:text-zinc-400 flex items-center justify-center gap-2 flex-wrap">
                ...
                Paiements sécurisés par Stripe • Annulation en 1 clic • Facture
                automatique
              </p>
            </div>
          </div>
        ...
        <section className="py-20 sm:py-32 relative overflow-hidden">
          ...
          <div className="container max-w-7xl mx-auto relative z-10 text-center text-white px-4 sm:px-6 lg:px-8">
        ...
        <div className="container max-w-7xl mx-auto py-12 px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div className="md:col-span-2">
              <Link
                href="/"
                className="font-bold text-xl text-zinc-900 dark:text-zinc-100 mb-3 inline-block"
              >
                Mon Petit Stock
              </Link>
              <p className="text-zinc-600 dark:text-zinc-400 max-w-md">
                La solution la plus simple pour gérer votre inventaire. Conçue
                pour les PME, artisans et associations.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2 text-sm">
                <Link
                  href="#features"
                  className="block text-zinc-600 dark:text-zinc-400 hover:text-purple-600 dark:hover:text-purple-400"
                >
                  Fonctionnalités
                </Link>
                <Link
